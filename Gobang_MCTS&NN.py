...
def train_agent(games=1000, mcts_simulations=100, model_path="model.txt", load_model_path=None):
    gobang = Gobang(size=6)
    memory = []
...
if __name__ == "__main__":
    train_agent(games=2000, mcts_simulations=100, model_path="model.txt", load_model_path="model.txt")
